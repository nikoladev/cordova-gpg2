...
public class GPGService2 implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public class Session {
        ...
        public HashMap<String, Object> toMap()
        {
            ...
            String scope = GPUtils2.scopeArrayToString(scopes);
            dic.put("state", scope);
    ...
    public static GPGService2 currentInstance() {
    ...
    public GPGService2(Activity activity)
    {
        sharedInstance = this;
    ...
    public void init(String[] extraScopes)
    {
        ...
        if (extraScopes != null) {
            for (String scope : extraScopes) {
                String value = GPUtils2.mapScope(scope);
    ...
    public boolean handleActivityResult(final int requestCode, final int resultCode, final Intent intent) {
        ...
        if ((requestCode == RESOLUTION_REQUEST_CODE || requestCode == GP_DIALOG_REQUEST_CODE) &&
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                String errorString = resultCode == Activity.RESULT_CANCELED ? null : GPUtils2.activityResponseCodeToString(resultCode);
    ...
    public void onConnectionFailed(com.google.android.gms.common.ConnectionResult connectionResult)
    {
        ...
        if (code == ConnectionResult.SIGN_IN_REQUIRED || code == ConnectionResult.RESOLUTION_REQUIRED) {
            ...
            {
                processSessionChange(null, connectionResult.getErrorCode(), GPUtils2.errorCodeToString(connectionResult.getErrorCode()) + " " + ex.getMessage());
            }
        }
        else {
            processSessionChange(null, connectionResult.getErrorCode(), GPUtils2.errorCodeToString(connectionResult.getErrorCode()));
        }
    }
        ...
        AsyncTask<Void, Void, Object> task = new AsyncTask<Void, Void, Object>() {
            ...
            protected void onPostExecute(Object info) {
                ...
                if (info instanceof Exception) {
                    ...
                    GPGService2.this.processSessionChange(null, 0, ex.getLocalizedMessage());
                    client.disconnect();
                }
                else {
                    GPGService2.this.processSessionChange(info.toString(), 0, null);
                }
            }
    ...
    public GPGService2.Session getSession() {

        if (authToken != null && client != null) {
            return new GPGService2.Session(authToken, scopes, getMe(), 0);
        }
        return null;
    }
    ...
    public void login(final String[] userScopes, final SessionCallback callback)
    {
        ...
        if (errorCode != ConnectionResult.SUCCESS) {
            ...
            if (GoogleApiAvailability.getInstance().isUserResolvableError(errorCode)) {
                ...
                callback.onComplete(null, new Error(GPUtils2.errorCodeToString(errorCode), errorCode));
            }
            return;
        }
    ...
    private void processFinalSnapshot(final Snapshot snapshot, final GPGService2.Error error, final SavedGameCallback callback) {
        ...
        AsyncTask<Void, Void, Boolean> updateTask = new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... params) {
                try {
                    ...
                    if (!GPUtils2.isEmpty(snapshotData.description)) {
